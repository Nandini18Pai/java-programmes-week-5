...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        ...
        // Input wizard for the user, and store hir/her input as a variable
        String userTuberStation = scan.next();
        ...
        for (int i = 0; i< tubeStationZone1.length; i++) {
            if (userTuberStation.equalsIgnoreCase(tubeStationZone1[i])) {
                catchStationName = tubeStationZone1[i];
            }
        }
         // Logic to find the Line names from the given from the user
        if (userTuberStation.equalsIgnoreCase(catchStationName)) {
            System.out.println(userTuberStation + " Station is in the Zone 1.");
            System.out.println("--------------------------------------------------------------------------");
            System.out.println("Following Line(s) passing through the Given tube Station: " + userTuberStation);
            System.out.println("--------------------------------------------------------------------------");
            ...
            for (int x = 0; x < londonUGLines.length; x++) {
                for (int y = 1; y < tubeStationZone1.length; y++) {
                   ...
                   // System.out.println(" I am here Line : 176" + match); // for debug purpose
                    if(userTuberStation.equalsIgnoreCase(match)) {
                        System.out.println(londonUGLines[x][0]); // first elements of multi dimension array is th line name
                    }
                }
            }
